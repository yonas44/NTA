...
RSpec.describe 'DailyMeals', type: :request do
  before(:all) do
    ...
    @daily_meal = FactoryBot.create(:daily_meal, nutritionist_id: @nutritionist.id, recipe_id: @recipe.id,
  ...
  describe 'POST /create' do
    it 'creates a daily_meal with the specified parameters' do
      post nutritionist_meal_plan_daily_meals_path(@nutritionist, @meal_plan),
  ...
  describe 'PATCH /update' do
    it 'updates a daily_meal with the specified parameters' do
      patch nutritionist_meal_plan_daily_meal_path(@nutritionist, @meal_plan, @daily_meal),
            params: { daily_meal: { recipe_id: @recipe.id, meal_type_id: @meal_type.id, meal_date: Date.today } }
