...
RSpec.describe 'ActiveAppointments', type: :request do
  ...
  describe 'POST /create' do
    it 'returns http success' do
      post client_active_appointments_path(@client),
           params: { active_appointment: { nutritionist_id: @nutritionist.id } }
      expect(response).to have_http_status(:success)
    end
  end
  ...
  describe 'GET /show' do
    it 'returns http success' do
      ...
      get client_active_appointment_path(@client, active_appointment),
          params: { active_appointment: { nutritionist_id: @nutritionist.id } }
      expect(response).to have_http_status(:success)
    end
  end
